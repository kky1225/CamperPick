	...
	<form:form id="update_form" action="updateRoom.do" modelAttribute="roomVO" enctype="multipart/form-data">
		...
		<ul>
			...
			<li>
				...
				<input type="number" id="people" name="people" value="${roomVO.people }">
				<form:errors path="people" cssClass="error-color"/>
			</li>
			<li>
				<label for="area">객실 면적</label>
				<input type="number" id="area" name="area" value="${roomVO.area }">
				<form:errors path="area" cssClass="error-color"/>
			</li>
			<li>
				<label for="price">가격</label>
				<input type="number" id="price" name="price" value="${roomVO.price }">
		...
		<div class="align-center">
			...
			<input type="button" value="목록" onclick="location.href='${pageContext.request.contextPath }/camping/detail.do?camping_num=${roomVO.camping_num }'">
		</div>
	</form:form>
</div>
<!-- 중앙 내용 끝 -->